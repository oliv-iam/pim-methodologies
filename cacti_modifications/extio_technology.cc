// added default rtt, r_on, t_flight values as well as the ability to set using input parameter
// modified DDR3 and DDR4 to take rtt values from input/defaults rather than arrays
